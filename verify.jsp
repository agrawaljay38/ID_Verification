<%-- 
    Document   : profile
    Created on : 1 Apr, 2020, 9:49:34 PM
    Author     : Asus
--%>
...
<div class="w3-top">
  <div class="w3-bar w3-red w3-card w3-left-align w3-large">
    ...
    <a href="#" class="w3-bar-item w3-button w3-padding-large w3-white">Verfication</a>
    <a href="registerFace.jsp" class="w3-bar-item w3-button w3-hide-small w3-padding-large w3-hover-white">Register Face</a>
...
<header class="w3-container w3-red w3-center" style="padding:28px 4px">
  <h1 class="w3-margin w3-jumbo">Verification</h1>
...
<div class="w3-row-padding w3-padding-64 w3-container">
  ...
  <div class="form">
      ...
      <form class="login-form" action="verify">
